...
import { dataDir, mysqlConfig } from "../server/config/runtime.mjs";
import { createDatabase } from "../server/db/connection.mjs";
import { bindCompanyPlanStore, initializeSchema } from "../server/db/company-plan-store.mjs";
